...
import ExpenseCategoryFormDrawer from "../components/ExpenseCategoryFormDrawer";
...
export default function ExpenseCategoriesPage() {
  ...
  const {
    ...
    loadById: loadExpenseCategoryById,
    clearErrors: clearExpenseCategoryErrors,
    clearCurrent: clearExpenseCategoryCurrent,
  });
  ...
  const handleDelete = async () => {
    ...
    const result = await dispatch(
      removeExpenseCategory(getRowId(deleteTarget)),
    );
    ...
    <>
      ...
      {status === "succeeded" && (
        <AdminDataTable
          columns={columns}
          rows={items}
          emptyMessage="No expense categories yet. Click Add to create one."
        />
      )}
